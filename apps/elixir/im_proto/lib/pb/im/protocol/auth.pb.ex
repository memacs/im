defmodule Pb.Im.Protocol.KickReason do
  @moduledoc false

  use Protobuf,
    enum: true,
    full_name: "im.protocol.KickReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field(:KICK_REASON_UNSPECIFIED, 0)
  field(:KICK_REASON_DUPLICATE_LOGIN, 1)
  field(:KICK_REASON_DEVICE_LIMIT, 2)
  field(:KICK_REASON_DEVICE_BANNED, 3)
  field(:KICK_REASON_ADMIN_KICK, 4)
  field(:KICK_REASON_TOKEN_EXPIRED, 5)
end
...
defmodule Pb.Im.Protocol.KickNotify do
  ...
  field(:reason_code, 5, type: Pb.Im.Protocol.KickReason, json_name: "reasonCode", enum: true)
end
